...
var displayMap = exports.displayMap = function displayMap(location) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoib3BvbmpvdXNtYXAiLCJhIjoiY20xNjl0NXhzMGhxcjJqcXZnaWtpczZpZSJ9.Ys-hU-v54Yg5HJv7Zd7TIA';
  ...
  location.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 25
    }).setLngLat(loc.coordinates).setHTML("Day <p>".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map);
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var stripe = Stripe('pk_test_51Q69jWLuxj0LewPQmIm1f6EEtSDQ9IBL671ziw6gsAdnCQzjJIrpnZVGyFHtaASuG9XMrjIBBcYByrU864yiljMb00MV84TZGo');
    ...
    var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            document.querySelector('.btn_save--password').textContent = 'updating...';
          ...
          case 7:
            document.querySelector('.btn_save--password').textContent = 'Save Password';
